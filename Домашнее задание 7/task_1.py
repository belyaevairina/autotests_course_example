...
class Segment:
    ...
    def length(self):
        length = ((self.section1[0] - self.section2[0]) ** 2 + (self.section1[1] - self.section2[1]) ** 2) ** 0.5
        return round(length, 2)

    def x_axis_intersection(self):
        return self.section1[1] <= 0 <= self.section2[1] or self.section2[1] <= 0 <= self.section1[1]

    def y_axis_intersection(self):
        return self.section1[0] <= 0 <= self.section2[0] or self.section2[0] <= 0 <= self.section1[0]
