...
def max_division_by_3(num):
    ...
    for i in range(len(num)):
        if int(num[i]) + remainder <= 9:
            ...
            return new_num
        # возможна ситуация, когда ни одной цифры увеличить нельзя, например, когда число состоит из
        # одних цифр 9, или для числа 888, или для числа 7878. В этом случае нужно уменьшить последнюю цифру числа
        # так, чтобы число стало кратным 3. Если в data  нет таких чисел так что эту часть кода можно отбросить вообще.
        # но для 999 оставим
        else:
            digit = int(num[-1])
            if remainder == 1:
